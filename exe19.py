...
qtdAlunos = 3 #inserir nessa variável a quantidade de alunos
...
while contAlunos <= qtdAlunos:
    ...
    notaDois = int(input("Insira a segunda nota do aluo: "))
    ...
    contAlunos += 1 #mesmo que contAlunos = contAlunos + 1
...
print(f"Alunos aprovados: {qtdReprovados}")
print(f"Alunos aprovados: {qtdExame}")
print(f"A média da classe foi: {mediaClasse}")